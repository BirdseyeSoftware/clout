    ...
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, d)) {
          ...
          return cljs.core.cons.call(null, a.group(cljs.core.int$.call(null, e + 1)), c.call(null, cljs.core.rest.call(null, d)))
        }
        return null
      }
    }, null)
  }.call(null, cljs.core.range.call(null, a.groupCount()))
};
clout.core.path_decode = function() {
  var a = null, b = function(b) {
    return a.call(null, b, "UTF-8")
  }, c = function(a) {
    return goog.string.urlDecode(clojure.string.replace.call(null, a, "+", goog.string.urlEncode("+")))
  }, a = function(a, e) {
    switch(arguments.length) {
      case 1:
        return b.call(this, a);
...
clout.core.assoc_vec = function(a, b, c) {
  return cljs.core.assoc.call(null, a, b, function() {
    var d = a.call(null, b);
    return cljs.core.truth_(d) ? cljs.core.vector_QMARK_.call(null, d) ? cljs.core.conj.call(null, d, c) : cljs.core.PersistentVector.fromArray([d, c], !0) : c
  }())
};
clout.core.assoc_keys_with_groups = function(a, b) {
  return cljs.core.reduce.call(null, function(a, b) {
    var e = cljs.core.nth.call(null, b, 0, null), f = cljs.core.nth.call(null, b, 1, null);
    return clout.core.assoc_vec.call(null, a, e, f)
  }, cljs.core.ObjMap.EMPTY, cljs.core.map.call(null, cljs.core.vector, b, a))
};
clout.core.request_url = function(a) {
  return[cljs.core.str(cljs.core.name.call(null, (new cljs.core.Keyword("\ufdd0'scheme")).call(null, a))), cljs.core.str("://"), cljs.core.str(cljs.core.get_in.call(null, a, cljs.core.PersistentVector.fromArray(["\ufdd0'headers", "host"], !0))), cljs.core.str((new cljs.core.Keyword("\ufdd0'uri")).call(null, a))].join("")
};
clout.core.path_info = function(a) {
  var b = (new cljs.core.Keyword("\ufdd0'path-info")).call(null, a);
  return cljs.core.truth_(b) ? b : (new cljs.core.Keyword("\ufdd0'uri")).call(null, a)
};
clout.core.Route = {};
clout.core.route_matches = function(a, b) {
  if(a ? a.clout$core$Route$route_matches$arity$2 : a) {
    return a.clout$core$Route$route_matches$arity$2(a, b)
  }
  var c;
  c = clout.core.route_matches[goog.typeOf(null == a ? null : a)];
  if(!c && (c = clout.core.route_matches._, !c)) {
    throw cljs.core.missing_protocol.call(null, "Route.route-matches", a);
  }
  return c.call(null, a, b)
};
clout.core.CompiledRoute = function(a, b, c, d, e) {
  this.re = a;
  this.keys = b;
  this.absolute_QMARK_ = c;
  this.__meta = d;
  this.__extmap = e;
  this.cljs$lang$protocol_mask$partition1$ = 0;
...
clout.core.CompiledRoute.prototype.cljs$core$IHash$_hash$arity$1 = function(a) {
  var b = this.__hash;
  return null != b ? b : this.__hash = a = cljs.core.hash_imap.call(null, a)
};
clout.core.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$2 = function(a, b) {
  return a.cljs$core$ILookup$_lookup$arity$3(a, b, null)
};
clout.core.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = function(a, b, c) {
  return"\ufdd0're" === b ? this.re : "\ufdd0'keys" === b ? this.keys : "\ufdd0'absolute?" === b ? this.absolute_QMARK_ : cljs.core._lookup.call(null, this.__extmap, b, c)
};
clout.core.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = function(a, b, c) {
  a = cljs.core.identical_QMARK_;
  return a.call(null, "\ufdd0're", b) ? new clout.core.CompiledRoute(c, this.keys, this.absolute_QMARK_, this.__meta, this.__extmap, null) : a.call(null, "\ufdd0'keys", b) ? new clout.core.CompiledRoute(this.re, c, this.absolute_QMARK_, this.__meta, this.__extmap, null) : a.call(null, "\ufdd0'absolute?", b) ? new clout.core.CompiledRoute(this.re, this.keys, c, this.__meta, this.__extmap, null) : new clout.core.CompiledRoute(this.re, this.keys, this.absolute_QMARK_, this.__meta, cljs.core.assoc.call(null, 
...
clout.core.CompiledRoute.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = function(a, b, c) {
  return cljs.core.pr_sequential_writer.call(null, b, function(a) {
    return cljs.core.pr_sequential_writer.call(null, b, cljs.core.pr_writer, "", " ", "", c, a)
  }, [cljs.core.str("#"), cljs.core.str("CompiledRoute"), cljs.core.str("{")].join(""), ", ", "}", c, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0're", this.re), cljs.core.vector.call(null, "\ufdd0'keys", this.keys), cljs.core.vector.call(null, "\ufdd0'absolute?", this.absolute_QMARK_)], !0), this.__extmap))
};
clout.core.CompiledRoute.prototype.cljs$core$ICollection$_conj$arity$2 = function(a, b) {
  return cljs.core.vector_QMARK_.call(null, b) ? a.cljs$core$IAssociative$_assoc$arity$3(a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
clout.core.CompiledRoute.prototype.cljs$core$ISeqable$_seq$arity$1 = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0're", this.re), cljs.core.vector.call(null, "\ufdd0'keys", this.keys), cljs.core.vector.call(null, "\ufdd0'absolute?", this.absolute_QMARK_)], !0), this.__extmap))
};
clout.core.CompiledRoute.prototype.cljs$core$ICounted$_count$arity$1 = function() {
  return 3 + cljs.core.count.call(null, this.__extmap)
};
clout.core.CompiledRoute.prototype.cljs$core$IEquiv$_equiv$arity$2 = function(a, b) {
  return cljs.core.truth_(function() {
    if(cljs.core.truth_(b)) {
...
clout.core.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
  return new clout.core.CompiledRoute(this.re, this.keys, this.absolute_QMARK_, b, this.__extmap, this.__hash)
};
clout.core.CompiledRoute.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
  return this.__meta
};
clout.core.CompiledRoute.prototype.cljs$core$IMap$_dissoc$arity$2 = function(a, b) {
  return cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'absolute?", "\ufdd0're", "\ufdd0'keys"]), b) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, a), this.__meta), b) : new clout.core.CompiledRoute(this.re, this.keys, this.absolute_QMARK_, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)), null)
};
clout.core.CompiledRoute.cljs$lang$type = !0;
clout.core.CompiledRoute.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "clout.core/CompiledRoute")
};
clout.core.CompiledRoute.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "clout.core/CompiledRoute")
};
clout.core.__GT_CompiledRoute = function(a, b, c) {
  return new clout.core.CompiledRoute(a, b, c)
};
clout.core.map__GT_CompiledRoute = function(a) {
  return new clout.core.CompiledRoute((new cljs.core.Keyword("\ufdd0're")).call(null, a), (new cljs.core.Keyword("\ufdd0'keys")).call(null, a), (new cljs.core.Keyword("\ufdd0'absolute?")).call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0're", "\ufdd0'keys", "\ufdd0'absolute?"))
};
clout.core.CompiledRoute;
clout.core.lex_1 = function(a, b) {
  return cljs.core.some.call(null, function(b) {
    var d = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null), d = clout.core.re_matcher.call(null, d, a);
    return cljs.core.truth_(d.lookingAt()) ? cljs.core.PersistentVector.fromArray([cljs.core.fn_QMARK_.call(null, b) ? b.call(null, d) : b, cljs.core.subs.call(null, a, d.end())], !0) : null
  }, cljs.core.partition.call(null, 2, b))
};
clout.core.lex = function() {
  var a = function(a, b) {
    for(var e = cljs.core.PersistentVector.EMPTY, f = a, g = b;;) {
      if(f = clout.core.lex_1.call(null, f, g), cljs.core.truth_(f)) {
        var h = f, f = cljs.core.nth.call(null, h, 0, null), h = cljs.core.nth.call(null, h, 1, null), e = cljs.core.conj.call(null, e, f);
...
clout.core.Route.string = !0;
clout.core.route_matches.string = function(a, b) {
  return clout.core.route_matches.call(null, clout.core.route_compile.call(null, a), b)
};
clout.test = {};
clout.test.core = {};
...
buster.spec.describe("fixed path", function() {
  buster.spec.it("", function() {
    var a = clout.core.route_matches.call(null, "/", clout.test.core.request.call(null, "\ufdd0'get", "/")), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'route-matches", "/", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = clout.core.route_matches.call(null, "/foo", clout.test.core.request.call(null, "\ufdd0'get", "/foo"));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'route-matches", "/foo", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = clout.core.route_matches.call(null, "/foo/bar", clout.test.core.request.call(null, "\ufdd0'get", "/foo/bar"));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'route-matches", "/foo/bar", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo/bar"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = clout.core.route_matches.call(null, "/foo/bar.html", clout.test.core.request.call(null, "\ufdd0'get", "/foo/bar.html"));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'route-matches", "/foo/bar.html", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo/bar.html"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
buster.spec.describe("keyword paths", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x", clout.test.core.request.call(null, "\ufdd0'get", "/foo")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":"foo"})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo")), cljs.core.hash_map("\ufdd0'x", "foo"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/foo/:x", clout.test.core.request.call(null, "\ufdd0'get", "/foo/bar")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":"bar"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/foo/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo/bar")), cljs.core.hash_map("\ufdd0'x", "bar"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/a/b/:c", clout.test.core.request.call(null, "\ufdd0'get", "/a/b/c")), cljs.core.ObjMap.fromObject(["\ufdd0'c"], {"\ufdd0'c":"c"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/a/b/:c", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/a/b/c")), cljs.core.hash_map("\ufdd0'c", "c"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:a/b/:c", clout.test.core.request.call(null, "\ufdd0'get", "/a/b/c")), cljs.core.ObjMap.fromObject(["\ufdd0'a", "\ufdd0'c"], {"\ufdd0'a":"a", "\ufdd0'c":"c"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:a/b/:c", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/a/b/c")), cljs.core.hash_map("\ufdd0'a", "a", "\ufdd0'c", "c"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
buster.spec.describe("keywords match extensions", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/foo.:ext", clout.test.core.request.call(null, "\ufdd0'get", "/foo.txt")), cljs.core.ObjMap.fromObject(["\ufdd0'ext"], {"\ufdd0'ext":"txt"})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/foo.:ext", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo.txt")), cljs.core.hash_map("\ufdd0'ext", "txt"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x.:y", clout.test.core.request.call(null, "\ufdd0'get", "/foo.txt")), cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y"], {"\ufdd0'x":"foo", "\ufdd0'y":"txt"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x.:y", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo.txt")), cljs.core.hash_map("\ufdd0'x", "foo", "\ufdd0'y", "txt"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
buster.spec.describe("hyphen keywords", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:foo-bar", clout.test.core.request.call(null, "\ufdd0'get", "/baz")), cljs.core.ObjMap.fromObject(["\ufdd0'foo-bar"], {"\ufdd0'foo-bar":"baz"})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:foo-bar", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/baz")), cljs.core.hash_map("\ufdd0'foo-bar", "baz"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:foo-", clout.test.core.request.call(null, "\ufdd0'get", "/baz")), cljs.core.ObjMap.fromObject(["\ufdd0'foo-"], {"\ufdd0'foo-":"baz"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:foo-", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/baz")), cljs.core.hash_map("\ufdd0'foo-", "baz"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
buster.spec.describe("underscore keywords", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:foo_bar", clout.test.core.request.call(null, "\ufdd0'get", "/baz")), cljs.core.ObjMap.fromObject(["\ufdd0'foo_bar"], {"\ufdd0'foo_bar":"baz"})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:foo_bar", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/baz")), cljs.core.hash_map("\ufdd0'foo_bar", "baz"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:_foo", clout.test.core.request.call(null, "\ufdd0'get", "/baz")), cljs.core.ObjMap.fromObject(["\ufdd0'_foo"], {"\ufdd0'_foo":"baz"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:_foo", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/baz")), cljs.core.hash_map("\ufdd0'_foo", "baz"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
buster.spec.describe("urlencoded keywords", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x", clout.test.core.request.call(null, "\ufdd0'get", "/foo%20bar")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":"foo bar"})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo%20bar")), cljs.core.hash_map("\ufdd0'x", "foo bar"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x", clout.test.core.request.call(null, "\ufdd0'get", "/foo+bar")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":"foo+bar"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo+bar")), cljs.core.hash_map("\ufdd0'x", "foo+bar"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x", clout.test.core.request.call(null, "\ufdd0'get", "/foo%5Cbar")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":"foo\\bar"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo%5Cbar")), cljs.core.hash_map("\ufdd0'x", "foo\\bar"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
buster.spec.describe("same keyword many times", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x/:x/:x", clout.test.core.request.call(null, "\ufdd0'get", "/a/b/c")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":cljs.core.PersistentVector.fromArray(["a", "b", "c"], !0)})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x/:x/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/a/b/c")), cljs.core.hash_map("\ufdd0'x", cljs.core.vec(["a", "b", "c"])))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/:x/b/:x", clout.test.core.request.call(null, "\ufdd0'get", "/a/b/c")), cljs.core.ObjMap.fromObject(["\ufdd0'x"], {"\ufdd0'x":cljs.core.PersistentVector.fromArray(["a", "c"], !0)}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/:x/b/:x", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/a/b/c")), cljs.core.hash_map("\ufdd0'x", cljs.core.vec(["a", "c"])))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
...
buster.spec.describe("wildcard paths", function() {
  buster.spec.it("", function() {
    var a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/*", clout.test.core.request.call(null, "\ufdd0'get", "/foo")), cljs.core.ObjMap.fromObject(["\ufdd0'*"], {"\ufdd0'*":"foo"})), b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/*", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo")), cljs.core.hash_map("\ufdd0'*", "foo"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/*", clout.test.core.request.call(null, "\ufdd0'get", "/foo.txt")), cljs.core.ObjMap.fromObject(["\ufdd0'*"], {"\ufdd0'*":"foo.txt"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/*", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo.txt")), cljs.core.hash_map("\ufdd0'*", "foo.txt"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/*", clout.test.core.request.call(null, "\ufdd0'get", "/foo/bar")), cljs.core.ObjMap.fromObject(["\ufdd0'*"], {"\ufdd0'*":"foo/bar"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/*", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo/bar")), cljs.core.hash_map("\ufdd0'*", "foo/bar"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/foo/*", clout.test.core.request.call(null, "\ufdd0'get", "/foo/bar/baz")), cljs.core.ObjMap.fromObject(["\ufdd0'*"], {"\ufdd0'*":"bar/baz"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/foo/*", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/foo/bar/baz")), cljs.core.hash_map("\ufdd0'*", "bar/baz"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    a = cljs.core._EQ_.call(null, clout.core.route_matches.call(null, "/a/*/d", clout.test.core.request.call(null, "\ufdd0'get", "/a/b/c/d")), cljs.core.ObjMap.fromObject(["\ufdd0'*"], {"\ufdd0'*":"b/c"}));
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'route-matches", "/a/*/d", cljs.core.list("\ufdd1'request", "\ufdd0'get", "/a/b/c/d")), cljs.core.hash_map("\ufdd0'*", "b/c"))), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
  return null
});
